...
@pytest.mark.parametrize(
    "pk_type, identity_type",
    (
        ("integer generated always as identity", "a"),
        ("integer generated by default as identity", "d"),
    ),
)
def test_repack_full_with_identity_pk(
    connection: _psycopg.Connection, pk_type: str, identity_type: str
) -> None:
    with connection.cursor() as cur:
        factories.create_table_for_repacking(
            connection=connection,
